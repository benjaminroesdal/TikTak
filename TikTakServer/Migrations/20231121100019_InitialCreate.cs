    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTagsInteractions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTagsInteractions_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTagsInteractions_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    BlobStorageId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTagsInteractions_TagId",
                table: "UserTagsInteractions",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTagsInteractions_UserId",
                table: "UserTagsInteractions",
                column: "UserId");
